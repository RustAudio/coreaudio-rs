...
impl AudioFormat {
    ...
    pub fn to_format_and_flag(&self) -> (libc::c_uint, Option<u32>) {
        match *self {
            AudioFormat::LinearPCM(flag)      => (1819304813, flag.bits()),
            AudioFormat::AC3                  => (1633889587, None),
            AudioFormat::F60958AC3(flag)      => (1667326771, flag.bits()),
            AudioFormat::AppleIMA4            => (1768775988, None),
            AudioFormat::MPEG4AAC(flag)       => (1633772320, flag as u32),
            AudioFormat::MPEG4CELP(flag)      => (1667591280, flag as u32),
            AudioFormat::MPEG4HVXC(flag)      => (1752594531, flag as u32),
            AudioFormat::MPEG4TwinVQ(flag)    => (1953986161, flag as u32),
            ...
            AudioFormat::TimeCode(flag)       => (1953066341, flag.bits()),
            AudioFormat::MIDIStream           => (1835623529, None),
            AudioFormat::ParameterValueStream => (1634760307, None),
            AudioFormat::AppleLossless(flag)  => (1634492771, flag.bits()),
